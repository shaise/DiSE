...
#define CUSTOM_KBD_EPIN_ADDR                 0x81U
#define CUSTOM_KBD_EPIN_SIZE                 0x02U
...
#define USBD_CUSTOM_KBD_REPORT_DESC_SIZE   45
...
typedef struct
{
  ...
  CUSTOM_HID_StateTypeDef     state[2];
}
